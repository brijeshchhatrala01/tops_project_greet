...
import 'package:tops_project_greet/pages/user/ragister/widgets/header.dart';
import '../constant.dart';
import 'package:http/http.dart' as http;

import '../front/front.dart';
import '../ragister/ragister.dart';
  ...
  void check_if_already_login() async {
    ...
    if (newuser == false) {
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const Front()));
    }
  }
